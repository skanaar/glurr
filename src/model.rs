...
pub fn create_natives() -> HashMap<&'static str, Nat> {
    return HashMap::from([
        ...
        ("invoke", Nat::Invoke),
        ("allot", Nat::Allot),
        ("jump-as-number", Nat::JumpAsNumber),
        ("string-as-number", Nat::StringAsNumber),
        ("var-as-number", Nat::VarAsNumber),
        ("array-as-number", Nat::ArrayAsNumber),
        ("number-as-jump", Nat::NumberAsJump),
        ("number-as-string", Nat::NumberAsString),
        ("number-as-var", Nat::NumberAsVar),
        ("number-as-array", Nat::NumberAsArray),
        ("set", Nat::Set),
        ("get", Nat::Get),
        ("display-image", Nat::DisplayImage),
        ("?", Nat::Questionmark),
        ("if", Nat::If),
        ("infinite", Nat::Infinite),
        ("loop", Nat::Loop),
        ("range", Nat::Range),
